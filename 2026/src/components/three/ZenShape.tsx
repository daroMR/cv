...
function TorusKnot() {
  ...
  useFrame(() => {
    ...
    meshRef.current.rotation.x = Math.sin(elapsed * 0.05) * 0.2
    meshRef.current.rotation.y = elapsed * 0.03
  })
  ...
  return (
    <mesh ref={meshRef}>
      ...
      <meshStandardMaterial wireframe transparent opacity={0.08} color="#4a7c9b" />
    </mesh>
  )
}
...
export default function ZenShape() {
  ...
  return (
    <div className="no-print" style={{ position: 'fixed', inset: 0, zIndex: -1, pointerEvents: 'none' }}>
